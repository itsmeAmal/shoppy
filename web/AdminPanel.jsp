<%-- 
    Document   : AdminPanel
    Created on : Jul 29, 2018, 7:54:05 PM
    Author     : Amal
--%>
            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="AdminPanel.jsp"> <h1>Shoppy.lk</h1> 
...
<!--slider menu-->
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="AdminPanel.html"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
